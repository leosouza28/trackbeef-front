...
@Component({
  selector: 'app-formas-pagamento-listar',
  templateUrl: './formas-pagamento-listar.component.html',
  styleUrls: ['./formas-pagamento-listar.component.scss']
})
export class FormasPagamentoListarComponent {
  ...
  async busca(q: any) {
    ...
    try {
      ...
      let data: any = await this.endpointsService.getFormasPagamento({ ...values });
      this.data = data;
    } catch (error) {
